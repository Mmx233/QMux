...
func TestServerConfigTemplateFields(t *testing.T) {
	...
	assert.Equal(t, config.ListenerCapacity{
		...
		MaxUDPSenderQueuedFramesPerGeneration:       config.DefaultMaxUDPSenderQueuedFramesPerGeneration,
		MaxUDPSenderQueuedBackingBytesPerGeneration: config.DefaultMaxUDPSenderQueuedBackingBytesPerGeneration,
		MaxUDPFragmentGroups:                        config.DefaultMaxUDPFragmentGroups,
		MaxUDPFragmentBackingBytes:                  config.DefaultMaxUDPFragmentBackingBytes,
	}, cfg.Listeners[0].Capacity)
	assert.Equal(t, config.DefaultTCPCopyBufferSize, cfg.TCPCopyBufferSize)
...
func TestClientConfigTemplateFields(t *testing.T) {
	...
	assert.Equal(t, config.ClientCapacity{
		MaxLocalUDPSessions:                  config.DefaultMaxLocalUDPSessions,
		MaxUDPFragmentGroupsPerHandler:       config.DefaultMaxUDPFragmentGroupsPerHandler,
		MaxUDPFragmentBackingBytesPerHandler: config.DefaultMaxUDPFragmentBackingBytesPerHandler,
	}, cfg.Capacity)
	assert.Equal(t, config.DefaultTCPCopyBufferSize, cfg.TCPCopyBufferSize)
